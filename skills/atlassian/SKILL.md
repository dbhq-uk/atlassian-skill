...
| Search, read, create or update a Confluence page | `${CLAUDE_SKILL_DIR}/references/confluence.md` |
...
4. **A Confluence `update` needs `--base-version`** - the version your edit started from. It refuses if the page has moved on.
